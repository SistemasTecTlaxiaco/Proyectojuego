...
<br>
<br>
<a class="botonr" role="button" style="width: 370px;height: 100px;background-image: url(../Imagenes/Nivel2/Grupo%203.png); float: center;" href="A18.php"></a>

<a href="A17.php" style=" background: url(../Imagenes/Menu/flecharegresa.png) /* Url de la imagen */ no-repeat center center 
/* Color del botón */; background-size: 125%; 
height: 90px;  /* Alto del botón */
  width: 100px;  /* Ancho del botón */ float: left; "class="botonR"></a>

<a href="A19.php" style=" background: url(../Imagenes/Menu/flecha.png) /* Url de la imagen */ no-repeat center center 
/* Color del botón */; background-size: 125%; 
height: 90px;  /* Alto del botón */
...
var img = new Image();
img.src = "../Imagenes/Nivel2/Planilla8.png";
