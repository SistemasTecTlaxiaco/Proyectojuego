...
<a href="#" style=" background: url(../Imagenes/Nivel3/6.png) /* Url de la imagen */ no-repeat center center 
...
<a href="A3.6.php" style=" background: url(../Imagenes/Menu/flecha.png) /* Url de la imagen */ no-repeat center center 
...
height: 90px;  /* Alto del botón */
  width: 100px;  /* Ancho del botón */"class="boton1"></a>
     <a href="A3.4.php" style=" background: url(../Imagenes/Menu/flecharegresa.png) /* Url de la imagen */ no-repeat center center 
/* Color del botón */; background-size: 125%; 
height: 90px;  /* Alto del botón */
