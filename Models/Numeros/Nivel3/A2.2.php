...
<img src="../Imagenes/Nivel3/9.png" width="10.4%" height="15%" />
<img src="../Imagenes/Nivel3/0.png" width="10%" height="15%" />
...
height: 90px;  /* Alto del botón */
  width: 100px;  /* Ancho del botón */"class="boton"></a>
    ...
    <a href="A2.1.php" style=" background: url(../Imagenes/Menu/flecharegresa.png) /* Url de la imagen */ no-repeat center center 
/* Color del botón */; background-size: 125%; 
height: 90px;  /* Alto del botón */
