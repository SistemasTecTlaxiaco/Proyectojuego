    ...
    <div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4"><img class="border rounded-circle" style="width: 300px;height: 300px;background-image: url(&quot;assets/img/voc_ece.png&quot;);"><audio controls=""></audio></div>
                <div class="col-md-4"></div>
            </div>
        </div>
    </div>
