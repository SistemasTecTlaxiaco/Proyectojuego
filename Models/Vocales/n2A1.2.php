...
<a href="n2A1.php" style=" background: url(&quot;assets/img/flecharegresa.png&quot;) /* Url de la imagen */ no-repeat center center 
/* Color del botón */; background-size: 125%; 
height: 90px;  /* Alto del botón */
  width: 100px;  /* Ancho del botón */ float: left; "class="botonR"></a>

<a href="n2A1.3.php" style=" background: url(&quot;assets/img/flecha.png&quot;) /* Url de la imagen */ no-repeat center center 
/* Color del botón */; background-size: 125%; 
height: 90px;  /* Alto del botón */
...
<a class="btn btn-primary text-right" role="button" style="width: 250px;height: 100px;background-image: url(&quot;assets/img/Grupo%203.png&quot;);  "href="n2A1.2.php"></a>
<br>
<br>
<br>
<br>
