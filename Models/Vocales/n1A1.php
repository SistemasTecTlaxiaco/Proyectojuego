...
<body style="background-image: url(&quot;assets/img/ejercicio2.jpg&quot;);">
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-right"><a class="btn btn-primary text-right border rounded-circle" role="button" style="width: 150px;height: 110px;background-image: url(&quot;assets/img/Grupo%2020.png&quot;);" href="nivel1.php"></a></div>
            </div>
        </div>
    </div>
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center"><video src="video/vocales.mp4" width="560" height="315" controls=""></video></div>
            </div>
            <div class="row">
